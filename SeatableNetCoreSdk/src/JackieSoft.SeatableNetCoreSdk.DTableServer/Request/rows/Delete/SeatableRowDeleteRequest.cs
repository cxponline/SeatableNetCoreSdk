...
{
    public class SeatableRowDeleteRequest : SeatableRowRequestBase, ISeatableDeleteRequest<SeatableResponse>
    {
        public SeatableRowDeleteRequest(string host, string dtable_uuid) : base(host, dtable_uuid)
        {
        }
