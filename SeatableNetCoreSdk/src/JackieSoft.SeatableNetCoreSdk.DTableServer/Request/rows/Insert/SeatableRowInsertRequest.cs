...
{
    public class SeatableRowInsertRequest : SeatableRowRequestBase, ISeatablePostRequest<SeatableResponse>
    {
        public SeatableRowInsertRequest(string host, string dtable_uuid) : base(host, dtable_uuid)
        {
        }
